/*
 * @Author: cuiweiqiang
 * @Date:   2018-06-21 16:56:35
 * @Last Modified by:   cuiweiqiang
 * @Last Modified time: 2018-06-21 18:29:31
 */
'use strict';
...
module.exports = class Command {
    constructor(options) {
        options = options || {};
        this.name = options.name || 'llk';
        this.configName = options.configName || 'llk-config';
    ...
    * getTemplateDir() {
    ...
    /**
     * fetch boilerplate mapping from `llk-config`
    ...
    * downloadBoilerplate(pkgName) {
        ...
        const saveDir = path.join(os.tmpdir(), 'llk-boilerplate');
